...
function App() {
  ...
  const projects = [
  { description: "Developed and deployed a react-based web application enabling students to publish and share creative contents in an organised manner", link: 'https://niec-writes.vercel.app', image: niecWrites },
